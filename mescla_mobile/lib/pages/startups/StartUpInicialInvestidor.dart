...
class _InvestPageState extends State<InvestPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Row(
            children: [
              Icon(Icons.circle, color: Color(0xFF34D399), size: 13),
              SizedBox(width: 12),
              Text(
                'Status: VIP Platinum',
                style: TextStyle(
          ...
          const Row(
            children: [
              Expanded(
                child: _InvestorMetric(
                  title: 'TOKENS EM CARTEIRA',
                  value: '500',
                  suffix: ' TKN',
                ),
              ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                _activityRow('Compra de Tokens (+100 TKN)', '12 Mai'),
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 16),
                  child: Divider(color: Color(0xFF2D374D), height: 1),
                ),
                _activityRow('Dividendos Recebidos (R\$ 240,00)', '01 Mai'),
              ],
            ),
          ),
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(color: Color(0xFF4B5563), width: 1.4),
                  ),
                  child: const Center(
                    child: Text(
                      'Vender tokens',
          ...
          const Center(
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.chat_bubble_outline, color: Color(0xFF94A3B8)),
                SizedBox(width: 12),
                Text(
                  'Pergunta Privada',
                  style: TextStyle(
  ...
  Widget _activityRow(String title, String date) {
    return Row(
      children: [
        Expanded(
          child: Text(
